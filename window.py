...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Station_in = QtWidgets.QTextEdit(self.groupBox)
        ...
        self.Lat_in = QtWidgets.QTextEdit(self.groupBox)
        self.Lat_in.setGeometry(QtCore.QRect(100, 60, 161, 31))
        self.Lat_in.setObjectName("Lat_in")
        self.Long_in = QtWidgets.QTextEdit(self.groupBox)
        ...
        self.Radius_in = QtWidgets.QTextEdit(self.groupBox_2)
        self.Radius_in.setGeometry(QtCore.QRect(120, 60, 151, 31))
