...
class MyApp(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.ui.testGraphUp.clicked.connect(self.runTestScalingDown)
        self.ui.testGraphDown.clicked.connect(self.runTestScalingUp)
        self.ui.waveUp.clicked.connect(self.waveScalingDown)
        self.ui.waveDown.clicked.connect(self.waveScalingUp)
    ...
    def adjustRangeAnal(self):
        ...
        self.minC = self.C[np.argmin(np.abs(self.F - self.maxFreq))]
        self.maxC = self.C[np.argmin(np.abs(self.F - self.minFreq))]
